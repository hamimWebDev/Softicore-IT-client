...
const Contact: NextPage = () => {
  return (
    <>
      ...
      <section className="section bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col justify-center items-center px-2 sm:px-4 mt-4">
        <div className="container-custom w-full">
          ...
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-16 justify-center items-stretch w-full">
            ...
            <AnimatedSection delay={0.2} direction="right" className="flex-1 min-w-0 w-full max-w-full md:max-w-lg mx-auto lg:mx-0 mb-8 lg:mb-0">
              <div className="bg-white dark:bg-gray-800/80 rounded-2xl shadow-xl p-6 sm:p-8 flex flex-col h-full justify-between border border-gray-200 dark:border-gray-700">
                <div>
                  ...
                  <div>
                    <div className="font-semibold text-gray-900 dark:text-white mb-2">Connect with me</div>
                    <div className="flex gap-4 flex-wrap">
                      <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="bg-gray-200 dark:bg-gray-700 hover:bg-primary-100 dark:hover:bg-primary-600 text-gray-900 dark:text-white p-2 rounded-full transition-colors">
                        <FiGithub size={20} />
                      </a>
                      <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="bg-gray-200 dark:bg-gray-700 hover:bg-primary-100 dark:hover:bg-primary-600 text-gray-900 dark:text-white p-2 rounded-full transition-colors">
                        <FiLinkedin size={20} />
                      </a>
                      <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="bg-gray-200 dark:bg-gray-700 hover:bg-primary-100 dark:hover:bg-primary-600 text-gray-900 dark:text-white p-2 rounded-full transition-colors">
                        <FiTwitter size={20} />
                      </a>
                    </div>
                  </div>
