...
const CreateWorkPage = () => {
  const [addWork, { isLoading, error }] = useCreateProductMutation()
          ...
          <form onSubmit={handleSubmit}>
            ...
            {!!error && (
              <div className="mt-4 text-red-600 font-semibold text-center">
                Error creating work. Please try again.
              </div>
            )}
            {submitted && (
              <div className="mt-4 text-green-600 font-semibold text-center">Work created successfully!</div>
            )}
          </form>
        </div>
      </PrivateRoute>
