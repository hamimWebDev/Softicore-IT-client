...
const FeaturesSection = () => {
    return (
        <section className="py-0 lg:py-24 bg-gradient-to-r from-blue-100 via-purple-50 to-pink-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
                {/* Left Side */}
                <div className="flex-1 max-w-xl">
                    <div className="text-indigo-500 dark:text-indigo-400 font-semibold mb-2 text-lg">Why Choose Softicore IT</div>
